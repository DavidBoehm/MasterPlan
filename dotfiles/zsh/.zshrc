...
# Plugins
plugins=(git z zsh-autosuggestions zsh-syntax-highlighting aliases history sudo copypath copyfile web-search common-aliases safe-paste extract colored-man-pages dircycle command-not-found)
